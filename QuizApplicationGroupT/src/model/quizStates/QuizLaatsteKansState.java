...
public class QuizLaatsteKansState implements QuizState, Serializable {
	...
	public void neemDeelAanQuiz(Quiz quiz) throws Exception {
		throw new Exception(String.format("Deelname aan quiz %s is nog mogelijk, doch je moet je haasten.", quiz));
