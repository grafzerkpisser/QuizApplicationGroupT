...
public class QuizOpengesteldState implements QuizState, Serializable {
	...
	@Override
	public void verwijderQuizOpdracht(Quiz quiz, QuizOpdracht quizOpdracht) throws Exception {
		throw new Exception(String.format("QuizOpdracht %s kan niet verwijderd worden uit Quiz %s.", quizOpdracht, quiz));
		
	}

	@Override
	public void voegQuizOpdrachtToe(Quiz quiz, QuizOpdracht quizOpdracht) throws Exception {
	...
	public void neemDeelAanQuiz(Quiz quiz) throws Exception {
		throw new Exception(String.format("Deelname aan quiz %s is nog mogelijk.", quiz));
